...
@Getter
@ToString
public class ManagerAuthToken extends AbstractAuthenticationToken {
	...
	public ManagerAuthToken(String usertoken, UserTypeEnum usertype, Collection<? extends GrantedAuthority> authorities) {
		super(authorities);
